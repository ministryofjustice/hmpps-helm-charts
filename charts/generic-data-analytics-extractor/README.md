...
This chart creates a standard cron job to extract **all data** from a database and send it to an s3 bucket for analysis.
...
```yaml
generic-data-analytics-extractor:
  databaseSecret: YOUR-DATABASE-SECRET-HERE
  analyticalPlatformSecret: YOUR-ANALYTICAL-PLATFORM-SECRET-HERE
```
